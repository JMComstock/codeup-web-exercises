...
for ( let user of users) {
    user.name = "Jason";
    user.email = "jasoncomstock11@email.com";
    user.languages = ['java, ASP.Net Core, python, mySQL'];
}
...
const languages = ['java, ASP.Net Core, python, mySQL'];
...
users = (user) => emails.push(user.email);
...
users.forEach(function(user) {
    ...
    const user = {name: 'jason', email: 'jason@email.com', languages: ['java, ASP.Net Core, python, mySQL']}
